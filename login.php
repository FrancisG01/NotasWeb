...
<html lang="es">
  <head>
    <meta charset="UTF-8">
    <title>NotasWeb | Iniciar Sesión</title>
       ...
       <div class="contenedor">
         <div class="contenedor-login">
           <div class="formulario">
             ...
             <form class="datos-login" method="post" action="log.php">
               ...
               <br>
               <input type="submit" name="enviar" value="Iniciar Sesión" class="btn-enviar">

             </form>

             <p>¿Aun no estas registrado? <a href="registrarse.php">Registrarse</a></p>
